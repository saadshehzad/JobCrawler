    ...
    def post(self, request, *args, **kwargs):
        ...
        for website in websites:
            if website.name.lower() == "linkedin":
                ...
                result.append({"website": website.name, "status": "error", "message": "Unsupported website"})
                continue
            ...
            if login:
                crawler.search_jobs()
                result.append({"website": website.name, "status": "success", "message": "Applied for jobs"})
            else:
                result.append({"website": website.name, "status": "error", "message": "Login failed"})
